...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { email: @hour.email, hourly_wage: @hour.hourly_wage, n_hour: @hour.n_hour, name_user: @hour.name_user } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { email: @hour.email, hourly_wage: @hour.hourly_wage, n_hour: @hour.n_hour, name_user: @hour.name_user } }
