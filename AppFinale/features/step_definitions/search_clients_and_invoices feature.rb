...
Scenario: See a client who is in the DB
	...
	Then I should see my client's information with and a list of the invoices related to him
...
Scenario: See a client who is in the DB but has no invoices related
	...
	When I type "Mario Rossi" in the bar
	And I click on "Search"
	Then If the list of invoices is empty I should see my client's information and a message "No invoices related"